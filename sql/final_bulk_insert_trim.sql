-- Versão final com TRIM no telefone
...
BEGIN
  ...
  SELECT
    (client->>'name'),
    (client->>'planner'),
    TRIM((client->>'phone')), -- Remover espaços do telefone
    (client->>'email'),
    (client->>'leader'),
    (client->>'mediator'),
    (client->>'manager'),
...
Execute no Supabase, depois delete os clientes, recarregue e tente novamente! 🚀
